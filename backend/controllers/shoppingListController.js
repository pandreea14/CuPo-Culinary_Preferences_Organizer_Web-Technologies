const { addShoppingList, fetchShoppingLists, deleteList, addItemToShoppingList } = require("../services/shoppingListService");
...
module.exports = { handleShoppingList, getShoppingList, handleDeleteList, addItemToList };
